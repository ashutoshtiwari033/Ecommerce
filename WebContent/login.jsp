...
<header>
			...
			<ul>
				...
				<c:choose>
					...
					<c:when test="${session != null}">
						...
						<li><a href="Controller?page=myacc&username=${username }">My Account</a></li>
					</c:when>
				</c:choose>
	...
	<div class="signup-header">
	 	<h2>Login to <mark>XFactor Store</mark></h2>
	</div>
	 ...
	 <input type="hidden" name="page" value="login-form">
	 	...
	 	<p>
	 		New to XFactor Store? <a href="Controller?page=sign-up" style="color:#F24638;">Create Account</a>
	 	</p>
	 </form>
	<br><br><br>
